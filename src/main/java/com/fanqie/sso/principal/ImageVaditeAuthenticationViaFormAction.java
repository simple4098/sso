...
public class ImageVaditeAuthenticationViaFormAction {
    ...
    public final void doBind(final RequestContext context, final UsernamePasswordCredential credentials) throws Exception {
    ...
    public final String submit(final RequestContext context, final UsernamePasswordCredential credentials, final MessageContext messageContext) throws Exception {
        // 检测验证码
            // 这个类也是我们自己搞的，里面能取到验证码
        /*    UsernamePasswordFanQieCredentials usernamePfq = (UsernamePasswordFanQieCredentials) credentials;
