 ...
 * under the License.
 */
package com.fanqie.sso.web.flow;
...
public final class ServiceAuthorizationCheck extends AbstractAction {
	...
	protected Event doExecute(final RequestContext context) throws Exception {
		...
		if (registeredService == null) {
			...
			throw new UnauthorizedServiceException("Unauthorized Service Access for Service: [ {} ] - service is not defined in the service registry.");
		}
			...
			throw new UnauthorizedServiceException("Unauthorized Service Access for Service: [ {} ] - service is not enabled in the service registry.");
		}
