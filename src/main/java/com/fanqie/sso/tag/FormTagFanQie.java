...
import com.fanqie.sso.function.FanQieFunction;
 ...
 * @version: v1.0.0
 */
public class FormTagFanQie extends AbstractHtmlElementTag {
        ...
        if (StringUtils.hasText(action)) {
            ...
            if (response instanceof HttpServletResponse) {
                ...
                if (StringUtils.hasText(queryString)) {
                    ...
                    //默认登录后往 service 参数后面的地址跳转
                    requestUri += "?" +"service="+ FanQieFunction.obtDefaultWebIndex();
                }
            }
